...
const pages = ['Emplois du temps', 'TODO List', 'Chat Positif', 'Chat académique', 'PDF', 'Partage Document'];
          ...
          <Box sx={{ flexGrow: 0 }}>
            <Tooltip title="Open settings">
              <IconButton onClick={handleOpenUserMenu} sx={{ p: 0 }}>
                <Avatar alt="Chayma Amri" src="/static/images/avatar/2.jpg" className="custom-avatar" />
              </IconButton>
            </Tooltip>
            <Menu
              sx={{ mt: '45px' }}
